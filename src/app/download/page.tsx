  ...
  return (
    <div className="min-h-screen pt-16 lg:pt-20 pb-8 lg:pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="text-center text-[#a0a0a0] py-8">Carregando...</div>
        ) : downloads.length > 0 ? (
          <>
            <section className="max-w-7xl mx-auto mb-6 lg:mb-8">
            ...
            {downloads.map((item, i) => (
              ...
              >
                <div className="relative aspect-square bg-[#111] p-3 lg:p-4 flex items-center justify-center">
                  {item.image ? (
                    <Image
                      src={item.image}
                      alt={item.title}
                    ...
                    <Download className="w-10 h-10 lg:w-12 lg:h-12 text-[#e50914]/40" />
                  )}
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-3">
                    <a
                      ...
                      className="bg-[#e50914] text-white text-xs lg:text-sm py-2 px-4 lg:px-5 rounded font-semibold hover:bg-[#f40612] transition-colors"
                    >
                      Baixar
                    </a>
                  </div>
                ...
                <div className="p-3 lg:p-4">
                  ...
                  <h3 className="font-semibold text-white text-sm lg:text-base mb-2 group-hover:text-[#e50914] transition-colors line-clamp-1">
                    {item.title}
                  </h3>
                </div>
              </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="text-center mt-6 lg:mt-8">
